		...
		<div className="grid grid--34 grid--landing">
			...
			<div className="grid__column grid__column--landing grid__column--7">
				<div className="grid__item grid__item--landing">
					<img src="https://www.reddymadedesign.com/wp-content/uploads/sites/2/2016/06/TWB-Ext-01_11TH-AVE-1600x1065.jpg" alt=""/>
				</div>
				<div className="grid__item grid__item--landing">
					<img src="https://www.reddymadedesign.com/wp-content/uploads/sites/2/2016/06/1_Shelter-800x1200.jpg" alt=""/>
				</div>
			</div>
